...
namespace AbpEventOrganizer.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpEventOrganizerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpEventOrganizerEfCoreEntityExtensionMappings to extend the IdentityUser entity
